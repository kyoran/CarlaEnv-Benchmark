...
class CarlaEnv(object):
    ...
    def reset_walkers(self):
        ...
        for one_part in range(len(walker_params)):
            ...
            while walker_num > 0:
                ...
                spawn_start_s = np.random.uniform(
                    walker_params["start_pos"][0],
                    walker_params["start_pos"][1],
                )
                ...
                if walker_actor:
                    ...
                    rand_destination = carla.Location(
                        x=np.random.uniform(walker_params["dest"]["x"][0], walker_params["dest"]["x"][1]),
                        y=random.choice([walker_params["dest"]["y"][0], walker_params["dest"]["y"][1]]),
                        z=0.
                    )
    ...
    def reset_sensors(self):
        ...
        def get_rgb_data(data, one_camera_idx):
            ...
            self.rgb_data['img'][:, one_camera_idx * self.rl_image_size:
                                    (one_camera_idx + 1) * self.rl_image_size, :] = array
        ...
        # self.sensors.append(self.rgb_camera_left2)
        # self.sensors.append(self.rgb_camera_left1)
        # self.sensors.append(self.rgb_camera_mid)
        # self.sensors.append(self.rgb_camera_right1)
        # self.sensors.append(self.rgb_camera_right2)
        ...
        if self.perception_type.__contains__("dvs"):
            ...
            # self.sensors.append(self.dvs_camera_left2)
            # self.sensors.append(self.dvs_camera_left1)
            # self.sensors.append(self.dvs_camera_mid)
            # self.sensors.append(self.dvs_camera_right1)
            # self.sensors.append(self.dvs_camera_right2)
        ...
        if self.perception_type.__contains__("vidar"):
            ...
            # self.sensors.append(self.vidar_camera_left2)
            # self.sensors.append(self.vidar_camera_left1)
            # self.sensors.append(self.vidar_camera_mid)
            # self.sensors.append(self.vidar_camera_right1)
            # self.sensors.append(self.vidar_camera_right2)
